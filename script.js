...
function handleGameCompletion(words) {
  ...
  const averageTimeInSeconds = 142;     
...
'1 Jun 2025': ['MUSIC', 'BLUES', 'METAL', 'INDIE', 'DISCO', 'SWING'],
...
'1 Jun 2025': ['Hint: Art form using sound, rhythm and melody'],
